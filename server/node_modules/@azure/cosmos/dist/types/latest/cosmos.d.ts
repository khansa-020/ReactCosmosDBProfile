           ...
           export declare class Databases {
                ...
                * @returns {@link QueryIterator} Allows you to return all databases in an array or iterate over them one at a time.
                 ...
                 * @returns {@link QueryIterator} Allows you to return all databases in an array or iterate over them one at a time.
                 ...
                 /** @hidden */
                 declare type FetchFunctionCallback = (diagnosticNode: DiagnosticNodeInternal, options: FeedOptions, correlatedActivityId: string) => Promise<Response_2<any>>;
                  ...
                  * @hidden
                  */
                 export declare type Plugin<T> = (context: RequestContext, diagnosticNode: DiagnosticNodeInternal, next: Next<T>) => Promise<Response_2<T>>;
